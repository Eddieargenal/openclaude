...
USERNAME="$(whoami)"
MEMORY_PROJECT_DIR="$HOME/.claude/projects/-Users-$USERNAME/memory"

echo "Installing OpenClaude memory system for user: $USERNAME"
echo ""
...
echo ""
echo "Next steps:"
echo "  1. Edit ~/.claude/projects/-Users-$USERNAME/memory/user_role.md"
echo "     — replace the placeholder with a description of yourself"
echo "  2. Add the oc() function to ~/.zshrc (see README-FORK.md Step 3)"
